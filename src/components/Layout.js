      ...
      return(
        ...
        <div id="amazingUnnecessaryContainer">
          <div className="slideContainer">
            ...
            <img className="mockup images" style={{backgroundImage: `url(${bart})`, backgroundPosition: 'center', backgroundSize: 'cover'}} value={this.state.email} onChange={this.handleEmail}/>
